...
void sendData(){
  String werte = String(temperature)+";"+String(humidity)+";"+String(absolute(temperature,humidity));
  
  server.send(200,"plain/text",werte);
}
void getData(){
...
printWifiStatus();
Serial.write(""+client.connect("192.168.1.22",80));
client.println("/data");
